        ...
        <v-card-text>
          <v-container>
            <v-row class="d-flex justify-content-around">
              <v-col cols="12"><v-text-field label="Dia" v-model="user.name" placeholder="User Name" required ></v-text-field></v-col>
              <v-col cols="12"><v-text-field label="Ejercicio" v-model="user.surname" ></v-text-field></v-col>
              <v-col cols="12">
                <v-text-field
                  label="Repeticiones" v-model="user.email"
                  required
                ></v-text-field>
              </v-col>
              <v-col>
